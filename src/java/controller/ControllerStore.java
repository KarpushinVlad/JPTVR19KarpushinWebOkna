    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (path) {
            ...
            case "/addProduct":
                ...
                request.setAttribute("info", "Новая пицца была добавлена");
            ...
            case "/buyProduct":
                ...
                if (product.getCount() > 0) {
                    if (buyer.getMoney() - product.getPrice() >= 0) {
                        ...
                        request.setAttribute("info", "Пицца \"" + product.getTitle() + "\"куплена клиентом: " + buyer.getName() + " " + buyer.getLastname());
                    } else {
                        request.setAttribute("info", "Недостаточно средств");
                    }

                } else {
                    request.setAttribute("info", "Все пиццы проданы");
                }
                request.getRequestDispatcher("/index.jsp")
                        .forward(request, response);
                break;
